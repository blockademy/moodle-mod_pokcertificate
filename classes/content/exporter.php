 ...
 */
namespace mod_pokcertificate\content;
...
class exporter extends abstract_mod_exporter {
    ...
    /**
     * Get the exportable items for mod_pokcertificate.
     *
    ...
    public function get_exportables(bool $includeuserdata = false): array {
        ...
        $contentitems[] = new exportable_textarea(
            $this->get_context(),
            $this->get_component(),
            get_string('content', 'mod_pokcertificate'),

            // Content is in the 'content' field of the 'pokcertificate' table.
            $this->get_modname(),
            'content',
            ...
            // The mod_pokcertificate content has files in 'content/0', and the itemid (0) is present in the URL.
            'content',
            0,
            0
        );
