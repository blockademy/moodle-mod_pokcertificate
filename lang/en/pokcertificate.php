...
$string['invalidauthenticationtoken'] = 'Please enter valid token';
...
$string['pokcertificate:managecoursecertificatestatus'] = 'Manage course certificate status';
$string['pokcertificate:bulkupdateincompleteprofile'] = 'Bulk update incomplete profile';
...
$string['certificatesent'] = 'Certificate Awarded to selected students or <br> emailed to their Emails Id`s';
