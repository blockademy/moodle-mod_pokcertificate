...
/**
 * Defines backup_pokcertificate_activity_task class
 *
...
require_once($CFG->dirroot . '/mod/pokcertificate/backup/moodle2/backup_pokcertificate_stepslib.php');
...
class backup_pokcertificate_activity_task extends backup_activity_task {
    ...
    /**
     * Defines a backup step to store the instance data in the pokcertificate.xml file
     */
